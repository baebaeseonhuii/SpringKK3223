...
public class StudentDAO {
	...
	public void makeStudent(StudentDTO sDTO) throws Exception {
		...
		sb.append(sDTO.getNum()).append(",").append(sDTO.getName()).append(",").append(sDTO.getKor()).append(",")
				.append(sDTO.getEng()).append(",").append(sDTO.getMath()).append(",").append(total).append(",")
				.append(avg).append("\n");
	...
	public void delete(StudentDTO sDTO) throws Exception {
		...
		for (StudentDTO sDTOtmp : sDTOs) {
			...
			sb.append(sDTOtmp.getNum()).append(",").append(sDTOtmp.getName()).append(",").append(sDTOtmp.getKor())
					.append(",").append(sDTOtmp.getEng()).append(",").append(sDTOtmp.getMath()).append(",")
	...
	public void update(StudentDTO sDTO) throws Exception {
		...
		for (int i = 0; i < sDTOs.size(); i++) {
			...
			sb.append(sDTOs.get(i).getNum()).append(",").append(sDTOs.get(i).getName()).append(",")
					.append(sDTOs.get(i).getKor()).append(",").append(sDTOs.get(i).getEng()).append(",")
					.append(sDTOs.get(i).getMath()).append(",").append(sDTOs.get(i).getTotal()).append(",")
					.append(sDTOs.get(i).getAvg()).append("\n");
